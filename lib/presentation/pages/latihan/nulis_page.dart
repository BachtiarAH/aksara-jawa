              ...
              Expanded(
                child: GridView.count(
                  ...
                  children: [
                    _buildMenuCard(
                      context: context,
                      imagePath: "assets/latihan_nulis_huruf.png",
                      title: 'Latihan Nulis Huruf',
                      subtitle: 'Latihan menulis\naksara dasar',
                      isPortrait: isPortrait,
                      onTap: () {
                        Navigator.pushNamed(
                            context, AppRoutes.latihanNulisHuruf);
                      },
                    ),
                    _buildMenuCard(
                      context: context,
                      imagePath: "assets/latihan_nulis_kata.png",
                      title: 'Latihan Nulis Tembung',
                      subtitle: 'Latihan menulis\nkata dalam aksara Jawa',
                      isPortrait: isPortrait,
                      onTap: () {
                        Navigator.pushNamed(
                            context, AppRoutes.latihanNulisTembung);
                      },
                    ),
                  ],
                ),
